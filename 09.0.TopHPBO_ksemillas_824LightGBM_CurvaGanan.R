...
#cargo el dataset
dataset <- fread("./datasets/06.0.Baseline.csv.gz") 
...
ruta  <- "~/buckets/b1/exp/HT8230v2_baseline/"
nombre  <- "BO_log.txt"
...
ganame <- paste0('10.0.Top', i, '_', k, 'semillas_pred-Ganan.csv')
fwrite(tb_prediccion, 
       file = ganame, sep = ",")      
}

# Genera CSV con los resultados de única Gananancia para c/u de los
fwrite(resultados, file = '10.0.Resumen_Ganancia_por_modelo.csv', sep = ",")
